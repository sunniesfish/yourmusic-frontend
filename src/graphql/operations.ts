...
export type SignInMutation = { __typename?: 'Mutation', signIn: { __typename?: 'SignInResponse', accessToken: string, user: { __typename?: 'User', userId: string, name: string, profileImg?: string | null } } };
...
export type ChangePasswordMutation = { __typename?: 'Mutation', changePassword: { __typename?: 'User', userId: string, name: string, profileImg?: string | null } };
...
export type RemovePlaylistMutationVariables = Types.Exact<{
  playlistId: Types.Scalars['String']['input'];
}>;
...
export type UpdateStatisticMutation = { __typename?: 'Mutation', updateStatistic: { __typename?: 'Statistic', updatedAt?: any | null, albumRankJson?: { __typename?: 'StatisticRank', first: string, second: string, third: string } | null, artistRankJson?: { __typename?: 'StatisticRank', first: string, second: string, third: string } | null, titleRankJson?: { __typename?: 'StatisticRank', first: string, second: string, third: string } | null } };
...
export type RemoveStatisticMutation = { __typename?: 'Mutation', removeStatistic: boolean };
...
export type GetUserQuery = { __typename?: 'Query', user: { __typename?: 'User', userId: string, name: string, profileImg?: string | null } };
...
export type GetPlaylistsByUserQuery = { __typename?: 'Query', playlistsByUser: { __typename?: 'PlaylistsResponse', edges: Array<{ __typename?: 'PlaylistEdge', cursor: string, node: { __typename?: 'Playlist', playlistId?: string | null, name?: string | null, createdAt?: any | null, thumbnail?: string | null, userId?: string | null, listJson?: Array<{ __typename?: 'PlaylistJSON', title?: string | null, artist?: string | null, album?: string | null, thumbnail?: string | null }> | null } }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean } } };
...
export type GetStatisticQuery = { __typename?: 'Query', statistic: { __typename?: 'Statistic', updatedAt?: any | null, albumRankJson?: { __typename?: 'StatisticRank', first: string, second: string, third: string } | null, artistRankJson?: { __typename?: 'StatisticRank', first: string, second: string, third: string } | null, titleRankJson?: { __typename?: 'StatisticRank', first: string, second: string, third: string } | null } };
